...
질문 몇 개에 답하면, 그 답이 그대로 **당신의 워크스페이스**가 됩니다 — 구조·조력자·규약·첫 산출물까지.

![Seed 온보딩 인터뷰](docs/img/interview.gif)

> *복사가 아니라 인터뷰.* 위는 예시 재연이며, 실제 `/onboard` 는 Claude Code 안에서 대화로 진행됩니다.
...
- 활용 사례: [`docs/cases/studio-guide.md`](docs/cases/studio-guide.md) — Seed로 만든 실제 결과물 (스튜디오 촬영 가이드)
